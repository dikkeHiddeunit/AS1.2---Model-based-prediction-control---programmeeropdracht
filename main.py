...
def build_transition_and_reward_matrices(maze):
    """Bouwt de transitie- en beloningsmatrices voor de omgeving."""
...
def visualize_path_with_arrows(path, actions, maze):
    """Geeft een visuele representatie van het pad met pijlen."""
    arrows = {0: '←', 1: '→', 2: '↑', 3: '↓'}
...
def main():
    """Hoofdfunctie die de omgeving opbouwt en waarde-iteratie uitvoert."""
    maze = Maze()
